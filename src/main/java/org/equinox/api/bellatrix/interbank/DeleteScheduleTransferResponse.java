...
public class DeleteScheduleTransferResponse extends BaseResponse {
	
	private static final long serialVersionUID = 1992806955692419059L;

	public DeleteScheduleTransferResponse() {
		super();
	}
