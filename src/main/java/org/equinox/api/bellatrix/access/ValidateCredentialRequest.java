...
public class ValidateCredentialRequest extends BaseMemberRequest {
	
	private static final long serialVersionUID = 1992806955692419007L;
	private int accessTypeId;
	private String credential;
	
	public ValidateCredentialRequest() {
		super(RequestPath.ACCESS, "validateCredential");
	}
