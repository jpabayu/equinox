...
public class QRComposer implements Serializable {

	private static final long serialVersionUID = 8892806955692419096L;
	...
	public String doCompose() {
		...
		if (crc != null) {
			...
			System.out.println("CRC Calculator Implementation Not Set");
		}
