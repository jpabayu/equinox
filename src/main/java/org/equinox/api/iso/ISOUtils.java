...
import org.equinox.api.GlobalComponent;
import org.equinox.api.cache.StanCounter;
...
public class ISOUtils {
	...
	public static String getMultibillerTid() {
		...
		return config.getString(Key.MULTIBILLER_ISO_TID);
	}
	
	//bit 41
	public static String getPlnTid() {
		Configuration config = Configuration.getInstance();
		return config.getString(Key.PLN_ISO_TID);
	}
	
	//bit 42
	public static String getMultibillerAccId() {
		Configuration config = Configuration.getInstance();
		return config.getString(Key.MULTIBILLER_ISO_ACC_ID);
	}
	
	//bit 42
	public static String getPlnAccId() {
		Configuration config = Configuration.getInstance();
		return config.getString(Key.PLN_ISO_ACC_ID);
	}
